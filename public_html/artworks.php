...
<main class="l-wrap-all l-wrap-all--split">
      ...
      <section class="l-wrap">
        ...
        <ul class="list">
          <?php
            ...
            while ($artwork = $res1->fetch_assoc()):
              ...
              if ($artwork['latitude'] !== NULL && $artwork['longitude'] !== NULL) {
                ...
                $letter = $alphas[count($map_results)];
                $index++;
                array_push($map_results, [
                  'title' => $title,
                  'url' => $url,
                  'photoURL' => $photo_url,
                  'lat' => $latitude,
          ...
          <li class="list__item">
            ...
            <?php if (isset($letter)): ?>
            <a href="#" data-index="<?php echo ($index - 1); ?>" class="action-map-center list__map-letter">
              <?php echo $letter; unset($letter); ?>
            </a>
            <?php endif; ?>
          </li>
          <?php endwhile; ?>
...
<?php if (!empty($map_results)): ?>
<script>
  window.mapResults = <?php echo json_encode($map_results); ?>;
</script>
<?php endif; ?>
